...
//        }
            ...
            url = "http://api.map.baidu.com/place/v2/search?ak=xMIlYtbWA3ImOX40wnrhDCxt&output=json&query=%E7%BB%B4%E4%BF%AE%E5%BA%97&page_size=10&page_num=0&scope=1&region=%E5%B9%BF%E5%B7%9E%E5%B8%82";
...
//                Log.i("info", s);
    ...
    public class Item {
         ...
         * @throws JSONException
         */
        private void dealItem(String s) throws JSONException, InterruptedException {
            Gson gson = new Gson();
...
//                if(!telephone.equals(null)){
                    ...
                    long l = dbWrita.insert("city", null, values);
